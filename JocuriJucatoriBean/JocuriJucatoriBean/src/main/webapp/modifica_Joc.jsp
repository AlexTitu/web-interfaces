...
<body style="background-image: url(&quot;assets/img/bckg1.jpg&quot;);">
    ...
    <h1 class="text-break text-uppercase" style="margin-left: 20px;margin-top: 10px;margin-bottom: 0px;color: rgb(148,74,208);font-family: 'Anonymous Pro', monospace;">Alege jocul ce doresti sa modifici:</h1>
    ...
    <p class="text-left d-xl-flex align-items-center align-content-center align-items-xl-center" style="font-family: 'Anonymous Pro', monospace;font-size: 30px;margin: 10px 10px 10px;color: rgb(254,255,255);font-style: normal;margin-left: 80px;margin-top: 5px;margin-right: 30px;margin-bottom: 0px;min-height: 60px;">Bifeaza o singura linie si apasa:</p>
    <input value="Modifica linia" class="btn btn-primary border-dark shadow-sm" type="submit" style="background-color: rgb(178,112,224);opacity: 1;font-family: Aldrich, sans-serif;color: rgb(255,255,255);margin-top: 5px;"id="modificaJoc" name="modificaJoc">
    </div>
