...
<html>
    ...
    <nav class="navbar navbar-light navbar-expand-md text-uppercase navigation-clean" style="background-color: rgba(88,88,88,0.54);font-family: Aldrich, sans-serif;color: #9a4edc;font-size: 19px;">
        ...
        <%
            ...
            if( data_nasterii == "") data_nasterii = null;
            String gen = request.getParameter("gen");
            if( gen == "") gen = null;
            String nationalitate = request.getParameter("nationalitate");
            if( nationalitate == "") nationalitate = null;
            if (nume != null && gen != null && prenume != null) {
            	
                jb.connect();
                jb.adaugaJucator(nume, prenume, email, data_nasterii, gen, nationalitate);
                jb.disconnect();
        %>
        ...
        %>
        <h1 align="center" class="display-4 text-break text-uppercase text-left d-xl-flex justify-content-start align-items-start align-content-start" style="font-family: 'Anonymous Pro', monospace;color: rgb(143,52,232);margin: 20px 30px 0px;font-style: normal;font-weight: bold;"align="center">Adauga Jucator Nou</h1>
        ...
        <form action="adauga_Jucator.jsp" method="post">
        <div class="table-responsive" style="color: rgb(255,255,255);margin-top: 30px;margin-bottom: 30px;font-family: 'Anonymous Pro', monospace;">
            <table align="center" class="table">
                ...
                <tr>
                    <td align="right">*Nume Jucator:</td>
                    <td> <input type="text" name="nume" size="45" /></td>
                </tr>
                <tr>
                    <td align="right">*Prenume Jucator:</td>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="data_nasterii" size="45" /></td>
                </tr>
                <tr>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
            ...
            <input value="Adauga jucator" class="btn btn-primary border-dark shadow-sm" type="submit" style="background-color: rgb(178,112,224);opacity: 1;font-family: Aldrich, sans-serif;color: rgb(255,255,255);margin-top: 5px;"id="adauga_Jucator" name="adauga_Jucator"/>
        	</div>
        </form>
        <%
            }
