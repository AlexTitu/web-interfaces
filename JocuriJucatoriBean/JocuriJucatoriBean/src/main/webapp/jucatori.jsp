...
<head>
    ...
    <link rel="stylesheet" href="assets/css/styles.css">
        ...
        $(document).ready(function () {
            $("#sterge_Jucator").hide();
            $("#modifica_Jucator").hide();
            
            $("#update").click(function () {
                $("#modifica_Jucator").show();
                $("#sterge_Jucator").hide();
...
<body style="background-image: url(&quot;assets/img/bckg1.jpg&quot;);">
    ...
    <h1 class="text-break text-uppercase" style="margin-left: 20px;margin-top: 10px;margin-bottom: 0px;color: rgb(148,74,208);font-family: 'Anonymous Pro', monospace;">The people behind the profiles</h1>
    
    <form action="modifica_Jucator.jsp" method="post">  
    ...
    <input type="checkbox" name="delete" id="update" style="margin-right: 20px;margin-left: 20px;" value="update" name="modify_check">
    <input value="Modifica datele" class="btn btn-primary border-dark shadow-sm" id="modifica_Jucator" name="modifica_Jucator"  type="submit" style="background-color: rgb(178,112,224);opacity: 1;font-family: Aldrich, sans-serif;color: rgb(255,255,255);margin-top: 5px;"> 
    </div>    
    </form>
    ...
    <div class="d-flex flex-shrink-1 justify-content-center align-items-center align-content-center align-self-center justify-content-xl-center">
    	...
    	<input type="checkbox" id="delete" style="margin-right: 20px;margin-left: 20px;" value="delete" name="delete">
    	<input class="btn btn-primary border-dark shadow-sm" id="sterge_Jucator" name="sterge_Jucator" type="submit" value ="Sterge liniile alese" style="background-color: rgb(178,112,224);font-family: Aldrich, sans-serif;color: rgb(255,255,255);margin-top: 5px;">
   	</div>
   	</form>
