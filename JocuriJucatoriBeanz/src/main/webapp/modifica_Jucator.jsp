...
<html>
    ...
    <h1 class="text-break text-uppercase" style="margin-left: 20px;margin-top: 10px;margin-bottom: 0px;color: rgb(148,74,208);font-family: 'Anonymous Pro', monospace;">Alege jucatorul ce doresti sa modifici:</h1>
    <form action="m1_Jucator.jsp" method="post">
    ...
    <input value="Modifica linia" class="btn btn-primary border-dark shadow-sm" type="submit" style="background-color: rgb(178,112,224);opacity: 1;font-family: Aldrich, sans-serif;color: rgb(255,255,255);margin-top: 5px;"id="modificaJoc" name="modificaJoc">Modify</button>  
    </div>
