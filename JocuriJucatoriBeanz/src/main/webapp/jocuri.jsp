...
<body style="background-image: url(&quot;assets/img/bckg1.jpg&quot;);">
    ...
    <h1 class="text-break text-uppercase" style="margin-left: 20px;margin-top: 10px;margin-bottom: 0px;color: rgb(148,74,208);font-family: 'Anonymous Pro', monospace;">The games we all love</h1>
    ...
    <p class="text-left d-xl-flex align-items-center align-content-center align-items-xl-center" style="font-family: 'Anonymous Pro', monospace;font-size: 30px;margin: 10px 10px 10px;color: rgb(254,255,255);font-style: normal;margin-left: 80px;margin-top: 5px;margin-right: 30px;margin-bottom: 0px;min-height: 60px;">Modifica:</p>
    <input type="checkbox" name="update" id="update" style="margin-right: 20px;margin-left: 20px;">
    <form action="modifica_Joc.jsp" method="post">
    <input value="Modifica datele" class="btn btn-primary border-dark shadow-sm" type="submit" style="background-color: rgb(178,112,224);opacity: 1;font-family: Aldrich, sans-serif;color: rgb(255,255,255);margin-top: 5px;" id="modificaJoc" name="modificaJoc"/>
    </form>
    </div>
    <form action="sterge_Joc.jsp" method="post">
        ...
        <table class="table">
            <thead style="color: rgb(255,255,255);">
                <tr>
                	...
                	<th>ID Joc</th>
                    <th>Nume</th>
                    <th>Numar Jucatori</th>
                    <th>Tip</th>
                    <th>Data Lansarii</th>
                    <th>Developer</th>
                    <th>Urmatorul Campionat</th>
                    <th>Numar Campionate</th>
                    <th>Campion Actual</th>
                </tr>
            </thead>
            <tbody style="color: rgb(255,255,255);">
                ...
                <tr>
                    ...
                    <td><%= rs.getString("nr_jucatori")%></td>
                    <td><%= rs.getString("tip")%></td>
                    <td><%= rs.getString("data_lansarii")%></td>
                    <td><%= rs.getString("developer")%></td>
                    <td><%= rs.getString("urmatorul_campionat")%></td>
                    <td><%= rs.getString("numar_campionate")%></td>
                    <td><%= rs.getString("campion_actual")%></td>
                    <%
                        }
                    %>
                </tr>
    ...
    <div class="d-flex flex-shrink-1 justify-content-center align-items-center align-content-center align-self-center justify-content-xl-center">
    <p style="font-family: 'Anonymous Pro', monospace;font-size: 30px;margin: 10px 10px 10px;color: rgb(254,255,255);font-style: normal;margin-left: 80px;margin-top: 5px;margin-right: 30px;margin-bottom: 0px;min-height: 60px;">Sterge:</p>       
        <input type="checkbox" name="delete" id="delete" style="margin-right: 20px;margin-left: 20px;" value="sterge" name="delete_check">
            <input class="btn btn-primary border-dark shadow-sm" type="submit" style="background-color: rgb(178,112,224);font-family: Aldrich, sans-serif;color: rgb(255,255,255);margin-top: 5px;" id="sterge_Joc" name="sterge_Joc" value="Sterge liniile marcate"/>
    </div>
    </form>
    <%
            rs.close();
