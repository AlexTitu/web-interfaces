...
<body style="background-image: url(&quot;assets/img/bckg1.jpg&quot;);">
    ...
    <h1 class="text-break text-uppercase" style="margin-left: 20px;margin-top: 10px;margin-bottom: 0px;color: rgb(148,74,208);font-family: 'Anonymous Pro', monospace;">Best players Among us</h1>
    <form action="modifica_Profil.jsp" method="post">
    ...
    <input type="checkbox" id="update" style="margin-right: 20px;margin-left: 20px;" value="modifica" name="modify_check">
    <button id="modificaProfil" name="modificaProfil" class="btn btn-primary border-dark shadow-sm" type="submit" style="background-color: rgb(178,112,224);opacity: 1;font-family: Aldrich, sans-serif;color: rgb(255,255,255);margin-top: 5px;">Modify</button>
    </div>
    </form>
    <form action="sterge_Profil.jsp" method="post">
    ...
    <div class="d-flex flex-shrink-1 justify-content-center align-items-center align-content-center align-self-center justify-content-xl-center">
    	<p class="text-left d-xl-flex align-items-center align-content-center align-items-xl-center" style="font-family: 'Anonymous Pro', monospace;font-size: 30px;margin: 10px 10px 10px;color: rgb(254,255,255);font-style: normal;margin-left: 80px;margin-top: 5px;margin-right: 30px;margin-bottom: 0px;min-height: 60px;">Sterge:</p>
    	<input type="checkbox" style="margin-right: 20px;margin-left: 20px;" value="sterge" id="delete" name="delete_check">
    	<input id="stergeProfil" name="stergeProfil" value="Sterge liniile selectate" class="btn btn-primary border-dark shadow-sm" type="submit" style="background-color: rgb(178,112,224);font-family: Aldrich, sans-serif;color: rgb(255,255,255);margin-top: 5px;">
  	</div>
  	</form>
  	<%
            rs.close();
